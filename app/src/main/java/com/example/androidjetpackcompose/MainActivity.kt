    ...
    Surface(
        ...
        Card(
            ...
            Column(
                ...
                // Portfolio button with click listener
                Button(
                    modifier = Modifier.padding(top = 16.dp),
                    onClick = {
                        // Action to execute when the button is clicked
                        // You can add your portfolio navigation or action here
...
private fun CreateInfoText(name: String) {
    Column {
        // Displays the greeting text with the name passed to this function
        Text(
            text = "Hello $name!",
...
@Preview(
    showBackground = true,
    name = "Business Card Preview" // Adding a name helps when you have multiple previews
)
@Composable
fun GreetingPreview() {
